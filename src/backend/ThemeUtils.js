...
//=New Variables
      ...
      $brand-primary:                         ${content.brandPrimary}!default; //--now-color--primary-1
      $brand-danger:                          ${content.brandDanger}!default; //--now-color_alert--critical-2
      $brand-warning:                         ${content.brandWarning}!default; //--now-color_alert--warning-2
      $brand-moderate:                        ${content.brandModerate}!default; //--now-color_alert--moderate-2 NEW
      $brand-low:                             ${content.brandLow}!default; //--now-color_alert--low-2 NEW
      $brand-success:                         ${content.brandSuccess}!default; //--now-color_alert--positive-2
      $brand-info:                            ${content.brandInfo}!default; //--now-color_alert--info-2

      $color-darkest:                         ${content.colorDarkest}; //--now-color--neutral-18
      $color-darker: 	                        ${content.colorDarker}; //--now-color--neutral-12
      $color-dark:                            ${content.colorDark}; //--now-color--neutral-10
      $color-disabled:                        ${content.colorDisabled}; //--now-color--neutral-6
      $color-light:                           ${content.colorLight}; //--now-color--neutral-4
      $color-lighter:                         ${content.colorLighter}; //--now-color--neutral-2
      $color-lightest:                        ${content.colorLightest}; //--now-color--neutral-0
      $color-accent:                          ${content.colorAccent}; //--now-color_selection--primary-2
      $color-accent-light:                    ${content.colorAccentLight}; //--now-color_selection--primary-1
      $color-accent-lightest:                 ${content.colorAccentLightest}; //--now-color_selection--primary-0

      //==Text color
      $text-primary:                          ${content.textPrimary}; //$text-color --now-color_text--primary
      $text-secondary:                        ${content.textSecondary}; //--now-color_text--secondary
      $text-tertiary:                         ${content.textTertiary}; //$text-muted --now-color_text--tertiary
      $text-white:                            ${content.textWhite}; //--now-color--neutral-0

      //==Backgrounds
      $background-primary:                    ${content.backgroundPrimary}; //--now-color_background--primary
      $background-secondary:                  ${content.backgroundSecondary}; //--now-color_background--secondary
      $background-tertiary:                   ${content.backgroundTertiary}; //--now-color_background--tertiary

      //==borders
      $border-primary:                        ${content.borderPrimary}; //--now-color_border--primary
      $border-secondary:                      ${content.borderSecondary}; //--now-color_border--secondary
      $border-tertiary:                       ${content.borderTertiary}; //--now-color_border--tertiary

      //==colors for selected
      $select-primary: 	                    ${content.selectPrimary}; //--now-color_selection--primary-2
      $select-primary-lighter: 	            ${content.selectPrimaryLighter}; //--now-color_selection--primary-0
      $select-primary-darker: 	            ${content.selectPrimaryDarker}; //--now-color_selection--primary-4

      //==Primary color 
      $brand-primary-darkest:                 ${content.brandPrimaryDarkest}; //--now-color--primary-3
      $brand-primary-darker:                  ${content.brandPrimaryDarker}; //--now-color--primary-2
      $brand-primary-lighter:                 ${content.brandPrimaryLighter}; //--now-color--interactive-1
      $brand-primary-lightest:                ${content.brandPrimaryLightest}; //--now-color--primary-0
      $brand-primary-opacity:				          ${content.brandPrimaryOpacity}; //--now-color--primary-0 (with opacity 0.5)

      //==Brand Darker colors
      $brand-danger-darker:                   ${content.brandDangerDarker}!default; //--now-color_alert--critical-3
      $brand-warning-darker:                  ${content.brandWarningDarker}!default; //--now-color_alert--warning-3
      $brand-moderate-darker:                 ${content.brandModerateDarker}!default; //--now-color_alert--moderate-3 
      $brand-low-darker:                      ${content.brandLowDarker}!default; //--now-color_alert--low-3 
      $brand-success-darker:                  ${content.brandSuccessDarker}!default; //--now-color_alert--positive-3
      $brand-info-darker:                     ${content.brandInfoDarker}!default; //--now-color_alert--info-3
      ...
      $sp-navbar-divider-color:               ${content.spNavbarDividerColor} !default; //--now-color_chrome--divider-10
      $sp-navbar-inverse-bg:                  $navbar-inverse-bg !default;
      $navbar-inverse-bg:                     ${content.navbarInverseBg} !default; //--now-color_chrome--brand-10
      $navbar-inverse-link-color:             ${content.navbarInverseLinkColor} !default; //--now-color--neutral-2
      $navbar-inverse-link-hover-color:       ${content.navbarInverseLinkHoverColor} !default; //--now-color--neutral-0
      ...
      $link-color:                            ${content.linkColor}; //--now-color--link-2
      $link-hover-color:                      ${content.linkHoverColor}; //--now-color--link-3
      ...
      $btn-success-bg:                        ${content.btnSuccessBg}; //--now-color_alert--positive-3
      $btn-success-border:                    $btn-success-bg;

      $btn-info-color:                        $text-primary; 
      $btn-info-bg:                           ${content.btnInfoBg}; //--now-color_alert--info-1
      $btn-info-border:                       $btn-info-bg;

      $btn-warning-color:                     $text-primary; 
      $btn-warning-bg:                        ${content.btnWarningBg}; //--now-color_alert--warning-1
      $btn-warning-border:                    $btn-warning-bg;

      $btn-danger-color:                      $text-white; 
      $btn-danger-bg:                         ${content.btnDangerBg}; //--now-color_alert--critical-3
      ...
      $input-border-focus:                    ${content.inputBorderFocus}; //--now-color--focus-2
      ...
      $state-success-bg:                           ${content.stateSuccessBg}; //--now-color_alert--positive-0
      $state-success-border:                      $brand-success;

      $state-info-text:                           $text-primary;
      $state-info-bg:                              ${content.stateInfoBg}; //--now-color_alert--info-0
      $state-info-border:                         $brand-info;

      $state-warning-text:                        $text-primary;
      $state-warning-bg:                           ${content.stateWarningBg}; //--now-color_alert--warning-0
      $state-warning-border:                      $brand-warning;

      $state-danger-text:                         $text-primary;
      $state-danger-bg:                            ${content.stateDangerBg}; //--now-color_alert--critical-0
      ...
      $badge-width-base :  50px;
      $badge-height-base : 50px;
