...
export default (pcolor, color, colors) => {
  colors.value.brandPrimary.value = pcolor;
  colors.value.brandPrimaryDarkest.value = colorFunctions.lighten(pcolor, 20);
  colors.value.brandPrimaryDarker.value = colorFunctions.lighten(pcolor, 40);
  colors.value.brandPrimaryLighter.value = colorFunctions.lighten(pcolor, 60);
  colors.value.brandPrimaryLightest.value = colorFunctions.lighten(pcolor, 80);
